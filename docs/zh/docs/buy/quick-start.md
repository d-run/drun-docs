...
3. 创建和导入语料库
    ...
    1. 打开左侧导航栏，点击 **智能问答** -> **语料库** -> **创建语料库** ，填写各项参数后，点击 **确定**
    ...
    1. 返回语料库列表，点击语料名称进入详情页，选择 **文件切片** 页签，输入一个问题进行搜索，例如`什么是边缘原生应用准则白皮书？`，可以看到搜索结果和对应的相似度。

        ![相似度](./images/image-16.png)

4. 创建聊天应用

    1. 从左侧导航栏，进入 **应用中心** ，点击右侧的 **创建** 按钮
...
1. 从左侧导航栏进入 **模型中心** ，依次选择 **模型服务** -> **在线模型服务** -> **新增 API 密钥** 按钮
