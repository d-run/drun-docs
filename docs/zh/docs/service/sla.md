...
2.5.1 您可以主动注销账号。 - 您可通过发送电子邮件至<info@daocloud.io>的方式向我们提出注销账号的请求。我们收到您的请求后将依照法律和本协议约定处理您的注销申请，将于【7】个工作日内完成账户注销。 - 您应当保证您的主动注销行为不侵犯我们或任何第三方的合法权益，否则我们有权拒绝您的注销请求。
