...
| 后台完全可操作 | d.run 提供 [SSH 登录和 JupyterLab](quickstart.md#_4) 两种方式访问小龙虾后台，支持完整的 CLI 操作，满足进阶用户的调试与定制需求。 |
...
| [飞书无缝集成](./feishu-integration.md) | 已上线 |
| 安全容器沙箱隔离 | 已上线 |
| 数据持久化存储 | 已上线 |
| [SSH/JupyterLab 后台访问](./quickstart.md#__tabbed_1_1) | 已上线 |
| 文件管理与上传 | 已上线 |
